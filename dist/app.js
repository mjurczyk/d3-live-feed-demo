...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.fetchServerState = fetchServerState;

	var _server = __webpack_require__(1);

	var _onMobile = __webpack_require__(2);

	var _ui = __webpack_require__(3);

	var _Gauge = __webpack_require__(5);
	 ...
	 */
	var SERVER_UPDATE_INTERVAL = 1500;

	/**
	 * Initialize UI according to the server-fetched data.
	 */
	function initializeUI() {
	  var gaugesListDom = document.querySelector('.app .gauges-list');

	  _server.initialState.forEach(function (data, index) {
	    (0, _Gauge.Gauge)({
	  ...
	  (0, _onMobile.onMobile)(function (_ref) {
	...
	function fetchServerState() {
	  setInterval(_server.getServerState, SERVER_UPDATE_INTERVAL);
	};
...
/***/ function(module, exports) {
	...
	var lastState = exports.lastState = initialState;
	...
	function getServerState() {
	  exports.lastState = lastState = lastState.map(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.showMobileUI = showMobileUI;
	exports.showDesktopUI = showDesktopUI;

	var _hammerjs = __webpack_require__(4);

	var appBody = document.querySelector('.app');
	var gaugesListElement = document.querySelector('.gauges-list');
	var gaugesIndicatorsListElement = document.querySelector('.gauges-list-indicators');

	var pivotMarginDeviation = 25;
	var pivotMarginThreshold = 50;
	var pivotMarginStep = 380;

	var mobileAppClassName = 'app-mobile';
	var activeIndicatorClassName = 'active';

	var swipeController = new _hammerjs.Manager(appBody);
	...
	function showMobileUI() {
	  var gaugesElements = Array.prototype.slice.call(document.querySelectorAll('.gauge'));
	  var gaugesCount = Array.prototype.slice.call(gaugesElements).length - 1;
	  var pivotMargin = 0;

	  appBody.className += ' ' + mobileAppClassName;

	  gaugesElements.forEach(function (element, index) {
	  ...
	  swipeController.on('pan', function (_ref) {
	    var deltaX = _ref.deltaX;

	    var deltaMargin = deltaX < 0 ? -pivotMarginDeviation : pivotMarginDeviation;

	    gaugesListElement.style.marginLeft = pivotMargin + deltaMargin;
	  });

	  swipeController.on('panend', function (_ref2) {
	    ...
	    if (pivotMargin + deltaPivot <= 0 && pivotMargin + deltaPivot >= -gaugesCount * pivotMarginStep) {
	      ...
	      Array.prototype.slice.call(document.querySelectorAll('.gauges-list-indicators div')).forEach(function (element, index) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Renderable = __webpack_require__(6);

	var _TextNumber = __webpack_require__(10);

	var _d = __webpack_require__(11);

	var d3 = _interopRequireWildcard(_d);

	var _gauge = __webpack_require__(12);

	var _gauge2 = _interopRequireDefault(_gauge);

	var _gauge3 = __webpack_require__(13);

	var _gauge4 = _interopRequireDefault(_gauge3);
	...
	var height = 187.5;
	var barWidth = 7.5;
	var crosshairPadding = 2;
	var crosshairWidth = 3;
	var radius = Math.min(width, height) / 2;
	var fullCircle = 2 * Math.PI;

	function renderGaugeGraph(svg, model) {
	  var valueSum = model.primary.value + model.secondary.value;
	  var secondaryValueRatio = model.secondary.value / valueSum;
	  var arc = d3.arc().innerRadius(radius - barWidth).outerRadius(radius).startAngle(0);

	  svg.selectAll('.value').data([1, secondaryValueRatio]).enter().append('g').attr('transform', 'translate(' + width / 2 + ',' + height / 2 + ')').append('path').datum(function (d, i) {
	    return {
	      endAngle: d * fullCircle
	    };
	  }).style('fill', function (d, i) {
	    return i === 0 ? model.primary.color : model.secondary.color;
	  }).attr('class', 'value').attr('d', arc);

	  svg.selectAll('.graph-line').data([0, 90]).enter().append('g').append('line').attr('x1', width / 2).attr('x2', width / 2).attr('y1', 0 + barWidth + crosshairPadding).attr('y2', height - barWidth - crosshairPadding).attr('stroke', '#ccc').attr('stroke-width', crosshairWidth).attr('transform', function (d, i) {
	    return 'rotate(' + d + ' ' + width / 2 + ' ' + height / 2 + ')';
	  });
	};

	function renderInnerGraph(svg, model) {
	  var backgroundRadius = radius - barWidth - crosshairPadding - crosshairWidth;
	  var maskRadius = backgroundRadius - crosshairPadding;

	  var arc = d3.arc().innerRadius(0).startAngle(0).endAngle(fullCircle);

	  svg.append('path').attr('transform', 'translate(' + width / 2 + ',' + height / 2 + ')').attr('fill', '#fff').datum(function (d) {
	    return {
	      outerRadius: backgroundRadius
	    };
	  }).attr('d', arc);

	  var graphColor = d3.color(model.primary.color);
	  graphColor.opacity = 0.5;

	  var clipPath = svg.append('clipPath').attr('id', 'inner-graph-clip').append('path').attr('transform', 'translate(' + width / 2 + ',-' + height / 2 + ')').datum(function (d) {
	    return {
	  ...
	  var lineChartData = model.pushHistory.slice(-10);
	  var lineChart = svg.append('g').append('path');
	  var trimLineChartData = function trimLineChartData(data) {
	    return [0].concat(data.concat(0));
	  };

	  lineChart.attr('transform', 'translate(0,' + height + ')').attr('clip-path', 'url(#inner-graph-clip)').data([trimLineChartData(lineChartData)]).style('stroke-width', 2).style('stroke', model.primary.color).style('fill', graphColor).style('opacity', '.35').attr('class', 'line').attr('d', line);

	  d3.interval(function () {
	    lineChartData = model.pushHistory.slice(-10);

	    lineChart.data([trimLineChartData(lineChartData.concat(0))]).transition(1500).attr('class', 'line').attr('d', line);
	  }, 1500);
	};
	...
	function Gauge(_ref) {
	  ...
	  var valueSum = model.primary.value + model.secondary.value;
	  var primaryRatio = ~~(model.primary.value / valueSum * 100);
	  var secondaryRatio = 100 - primaryRatio;
	  var enrichedModel = Object.assign({}, model, {
	    primaryRatio: primaryRatio,
	    secondaryRatio: secondaryRatio,
	    valueSum: (0, _TextNumber.TextNumber)(valueSum),
	    valueSumUnit: model.primary.valueUnit || model.secondary.valueUnit,
	    primary: Object.assign({}, model.primary, {
	      value: (0, _TextNumber.TextNumber)(model.primary.value)
	    }),
	    secondary: Object.assign({}, model.secondary, {
	      value: (0, _TextNumber.TextNumber)(model.secondary.value)
	    })
	  });
	  var elementDom = (0, _Renderable.Renderable)({
	    parent: parent,
	    id: id,
	    template: _gauge2.default,
	    model: enrichedModel
	  });

	  var labelPrimary = elementDom.querySelector('.gauge-inner__primary .gauge-inner__label');
	  var labelSecondary = elementDom.querySelector('.gauge-inner__secondary .gauge-inner__label');
	  labelPrimary.style.color = model.primary.color;
	  labelSecondary.style.color = model.secondary.color;

	  var svg = d3.select('#' + id + ' .gauge-graph').append('svg').attr('width', width).attr('height', height);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _renderTemplate = __webpack_require__(7);

	var _logger = __webpack_require__(9);

	function Renderable(_ref) {
	  var parent = _ref.parent;
	  var id = _ref.id;
	  var template = _ref.template;
	  var model = _ref.model;

	  var elementDom = void 0;
	  var renderedTemplate = void 0;

	  if (!parent) {
	    (0, _logger.warning)('No parent specified for a Renderable component.');
	    return;
	  }

	  if (!id) {
	    (0, _logger.warning)('No id specified for a Renderable component. Component may be overriden without notice.');
	  }

	  renderedTemplate = (0, _renderTemplate.renderTemplate)(template, model);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getDeepValueByString = __webpack_require__(8);
	...
	function renderTemplate() {
	  ...
	  return template.replace(/{([^}]+)}/gm, function (match, key) {
	    return (0, _getDeepValueByString.getDeepValueByString)(values, key) || '';
	  });
	};
...
/***/ function(module, exports) {
	...
	exports.getDeepValueByString = getDeepValueByString;
	/**
	 ...
	 */
	function getDeepValueByString() {
	  var object = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
	  var key = arguments.length <= 1 || arguments[1] === undefined ? '' : arguments[1];

	  return key.split(/\./g).reduce(function (value, subkey) {
	    if (value === null) {
	      return null;
	    } else {
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"gauge\">\n  <div class=\"gauge-graph\">\n    <div class=\"gauge-graph__label\">\n      {label}\n      <div class=\"gauge-graph__label__value\">\n        {valueSum}{valueSumUnit}\n      </div>\n    </div>\n  </div>\n  <div class=\"gauge-inner\">\n    <div class=\"gauge-inner__primary\">\n      <div class=\"gauge-inner__label\">\n        {primary.label}\n      </div>\n      <div class=\"gauge-inner__value\">\n        <span class=\"gauge-inner__value__percentage\">\n          {primaryRatio}%\n        </span>\n        {primary.value}{primary.valueUnit}\n      </div>\n    </div>\n    <div class=\"gauge-inner__secondary\">\n      <div class=\"gauge-inner__label\">\n        {secondary.label}\n      </div>\n      <div class=\"gauge-inner__value\">\n        <span class=\"gauge-inner__value__percentage\">\n          {secondaryRatio}%\n        </span>\n        {secondary.value}{secondary.valueUnit}\n      </div>\n    </div>\n  </div>\n</div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./gauge.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./gauge.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".gauge {\n  display: inline-block;\n  width: 300px;\n  padding: 15px;\n  margin-left: 25px;\n  margin-right: 25px;\n}\n\n.gauge-graph {\n  position: relative;\n  text-align: center;\n  z-index: 1;\n}\n\n.gauge-inner {\n  display: flex;\n  width: 100%;\n  justify-content: space-between;\n  text-align: left;\n  margin-top: 5px;\n  padding-bottom: 10px;\n  border-bottom: solid 2px #e6e6e6;\n}\n\n.gauge-inner__label {\n  font-weight: bold;\n  text-transform: capitalize;\n}\n\n.gauge-inner__value {\n  color: #d4d4d4;\n}\n\n.gauge-inner__value__percentage {\n  color: #afafaf;\n  margin-right: 10px;\n}\n\n.gauge-inner__secondary {\n  text-align: right;\n}\n\n.gauge-graph__label {\n  position: absolute;\n  width: 100%;\n  top: 50%;\n  transform: translateY(-75%);\n  text-align: center;\n  text-transform: uppercase;\n  font-size: 18px;\n  font-weight: 400;\n  color: #c1c1c1;\n  z-index: 2;\n}\n\n.gauge-graph__label__value {\n  color: #333;\n  font-size: 24px;\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html, body {\n  margin: 0;\n  margin-top: 5px;\n  padding: 0;\n  font-family: 'Roboto', sans-serif;\n  font-size: 16px;\n  color: #111;\n}\n\n.app {\n  text-align: center;\n  white-space: nowrap;\n}\n\n.app-mobile {\n  position: relative;\n  width: 380px;\n  margin: 0 auto;\n  overflow: hidden;\n}\n\n.app-mobile .app-inner {\n  border: solid 1px #ccc; \n}\n\n.gauges-list {\n  margin-left: 0px;\n  transition: margin-left 0.5s ease;\n}\n\n.gauges-list-indicators {\n  display: none;\n  margin-top: 15px;\n}\n\n.gauges-list-indicators div {\n  display: inline-block;\n  width: 10px;\n  height: 10px;\n  margin: 2.5px;\n  background-color: #d4d4d4;\n  border-radius: 100%;\n  transition: background-color 0.2s ease;\n}\n\n.gauges-list-indicators div.active {\n  background-color: #afafaf;\n}\n\n.app-mobile .gauges-list-indicators {\n  display: inline-block;\n}", ""]);
